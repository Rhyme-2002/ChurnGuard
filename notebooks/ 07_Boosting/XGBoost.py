...
# Data Preprocessing & xgboost Pipeline
...
model = Pipeline([("preprocessing", preprocessing), ("classifier", XGBClassifier())])
...
# GridSearchCV
grid_xgb = GridSearchCV(estimator=model, param_grid=param_grid, cv=5, scoring="accuracy", n_jobs=-1, verbose=1, return_train_score=True)
